...
Transforming swine production through microbiome science
...
const $$Research = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<section id="research" class="py-20 px-6 md:px-12 bg-white"> <div class="container mx-auto max-w-6xl pt-20"> <div class="text-center mb-16"> <h2 class="text-4xl font-bold mb-4 section-heading">Our Research Focus</h2> <p class="text-gray-600 max-w-3xl mx-auto">
...
const $$Approach = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<section id="approach" class="py-20 px-6 md:px-12 bg-white" data-astro-cid-ouou2mig> <div class="container mx-auto max-w-6xl pt-20" data-astro-cid-ouou2mig> <div class="text-center mb-16" data-astro-cid-ouou2mig> <h2 class="text-4xl font-bold mb-4 section-heading" data-astro-cid-ouou2mig>Our Collaborative Approach</h2> <p class="text-gray-600 max-w-3xl mx-auto" data-astro-cid-ouou2mig>
...
Now I link microbial activity to feed efficiency, growth, and resilience using modeling, bioinformatics, and field data.`
  ...
  return renderTemplate`${maybeRenderHead()}<section id="team" class="py-20 px-6 md:px-12 bg-umn-off-white" data-astro-cid-yu4wt3u2> <div class="container mx-auto max-w-6xl pt-20" data-astro-cid-yu4wt3u2> <div class="text-center mb-16" data-astro-cid-yu4wt3u2> <h2 class="text-4xl font-bold mb-4 section-heading" data-astro-cid-yu4wt3u2>Research Team</h2> <p class="text-gray-600 max-w-3xl mx-auto text-lg" data-astro-cid-yu4wt3u2>
...
const $$HybridResources = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<section id="resources" class="py-20 px-6 md:px-12 bg-gray-50"> <div class="container mx-auto max-w-6xl pt-10"> <div class="text-center mb-16"> <h2 class="text-4xl font-bold mb-4 section-heading">Educational Resources</h2> <p class="text-gray-600 max-w-3xl mx-auto text-lg">
